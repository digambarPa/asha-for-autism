define(["app", "angular"], function (module, angular) {
    ...
    var headerComponent = {
        ...
        <div class="row header">
        	<div class="col-md-11 col-sm-10 col-xs-9"><h2 class="heading" style="text-align: left; margin-top: 10px;"><strong>Academy for Severe Handicaps and Autism</strong></h2></div>
        </div>
        <div class="row">
        <div class="col-md-12">
        <div>
